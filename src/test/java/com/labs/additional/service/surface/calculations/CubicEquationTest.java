...
class CubicEquationTest {
    ...
    void isEmpty_whenAllCubicCoefficientsAreZero() {
        ...
        List<Double> result = cubicEquation.solve(1.0, 0.0, 0.0, 0.0);
    ...
    void oneCubicNotZeroRoot_whenGivenOnlyNotZeroI1() {
        for (double I1 = -10; I1 <= 10; I1 += .5) {
            ...
            List<Double> result = cubicEquation.solve(1.0, I1, 0.0, 0.0);
    ...
    void threeCubicNotZeroRoots_whenNotZeroI3() {
        ...
        List<Double> resul = cubicEquation.solve(1.0, 13.4, -22.5, I3);
